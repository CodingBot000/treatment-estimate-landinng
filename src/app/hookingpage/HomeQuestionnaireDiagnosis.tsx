...
export default function HomeQuestionnaireDiagnosis() {
  ...
  return (
    <section id="quote" className="py-20 min-h-screen bg-purple-400">
...
{/*       
        ...
        <div
          ...
          >
            ...
            <p className="mb-2">Receive free quotes from premium clinics for <span className="text-purple-700 font-semibold">personalized anti-aging treatments </span>
