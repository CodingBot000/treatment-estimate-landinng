...
export const formDefinition: FormDefinitionProps[] = [
  {
    id: "q1",
    type: "multi-select",
    label: "현재 피부 상태에 대해 알려주세요",
    options: [
